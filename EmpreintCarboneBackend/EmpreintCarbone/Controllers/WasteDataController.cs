...
namespace EmpreintCarbone.API.Controllers
{
    ...
    {
        private readonly IWasteDataService _service;

        public WasteDataController(IWasteDataService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(WasteDataDto dto)
        {
            dto.UserId = GetUserId();
            await _service.AddAsync(dto);
            return Ok("waste data created.");
        }
        ...
        [HttpPut]
        public async Task<IActionResult> Update(WasteDataDto dto)
        {
            dto.UserId = GetUserId();
            await _service.UpdateAsync(dto);
            return Ok("waste data updated.");
        }
